...
Most of the fun to be had with article data is achieved by joining it to other datasets, but how to do so and what can be achieved are described in the notebooks for those datasets.
...
```{r Grouping by type, echo=TRUE}
  ...
  summarise(group_by(articles, type), total = n())
