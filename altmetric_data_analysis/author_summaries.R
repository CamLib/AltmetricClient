...
authors <- read_csv("../files_out/20180130_0810_authors.csv")
mentions <- read_csv("../files_out/20180130_0810_mentions.csv")
articles <- read_csv("../files_out/20180130_0810_master.csv")
